            ...
            <div className={styles.cookie_container}>
                <div className={styles.cookie_content}>
                    ...
                    <p className={styles.cookie_text}>
                        In order to enhance your experience across our platforms and show you more relevant information, we use cookies and similar technologies, both SignXpert owned and third party owned, as well as data sent directly from our servers. You can manage your preferences anytime in <a href="/privacy-policy" className={styles.cookie_link}> Privacy & Cookie Settings</a>.
                    </p>
                ...
                <div className={styles.cookie_buttons}>
                    <button
                        className={styles.cookie_button_accept}
                        onClick={handleAccept}
                    >
                        Accept all
                    </button>
                    <button
                        className={styles.cookie_button_decline}

...
const CutSelector = ({ isOpen, onClose }) => {
  ...
  const addCut1 = () => {
    if (canvas) {
      ...
      const path = new fabric.Path(
        ...
        "M31.86,-103.03L31.86,-105.87L37.53,-105.87L37.53,-103.03C46.25,-104.50,52.38,-112.41,51.64,-121.22C50.90,-130.03,43.54,-136.81,34.70,-136.81C25.85,-136.81,18.49,-130.03,17.75,-121.22C17.01,-112.41,23.14,-104.50,31.86,-103.03z",
        {
          left: centerX,
          top: centerY,
          originX: "center",
  ...
  const addCut6 = () => {
    if (canvas) {
      ...
      const border = new fabric.Path(
        "M98.67,-226.28C100.04,-211.46,111.78,-199.71,126.61,-198.35L126.61,-200.05L132.28,-200.05L132.28,-198.35C147.10,-199.71,158.84,-211.46,160.21,-226.28L158.51,-226.28L158.51,-231.95L160.21,-231.95C158.84,-246.78,147.10,-258.52,132.28,-259.88L132.28,-258.18L126.61,-258.18L126.61,-259.88C111.78,-258.52,100.04,-246.78,98.67,-231.95L100.37,-231.95L100.37,-226.28L98.67,-226.28z",
        {
          left: centerX,
          top: centerY,
          originX: "center",
  ...
  const addCut7 = () => {
    if (canvas) {
      ...
      const path = new fabric.Path(
        "M209.38,-262.97C191.63,-260.59,178.77,-244.85,179.96,-226.99C181.16,-209.12,196.00,-195.24,213.90,-195.24C231.81,-195.24,246.65,-209.12,247.84,-226.99C249.04,-244.85,236.18,-260.59,218.43,-262.97C218.27,-260.59,216.29,-258.74,213.90,-258.74C211.52,-258.74,209.54,-260.59,209.38,-262.97z",
        {
          left: centerX,
          top: centerY,
          originX: "center",

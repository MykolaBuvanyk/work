    ...
    <div className='contacts-container'>
        ...
        <div className="contact">
            <div className="info">
                ...
                <div className='number'>+380982594416</div>
                <h2 style={{marginBottom:'0'}}>E-mail</h2>
                <Link to={'malito:info@sign-xpert.com'}>info@sign-xpert.com</Link>
                <h2 style={{marginTop:'25px',marginBottom:'5px'}}>Registered Address</h2>
                <div className="address">
                    Baumwiesen 2 Haigerloch 72401 Germany
                </div>
                <h2 style={{marginTop:'25px',marginBottom:'5px'}}>Opening Times</h2>
                <div className="time-work">Monday - Friday, 08:00 - 19:00</div>
            </div>
            <div className="form">
                <h2>Or use this form to contact us</h2>
                <form>
                    <label htmlFor="name">
                        Name
                        <input type="text" />
